import ScrollHighlightText from "./Scroll"
function Third(){
    return(
        <div className=" flex justify-center ">
            ...
            {/* Right part */}
            <div className="flex flex-col w-full md:max-w-135 h-[496px] lg:h-105 gap-3 sm:h-auto sm:gap-4 md:h-auto md:gap-5 lg:justify-between">
                ...
                <ScrollHighlightText className="text-[18px] md:text-[16px] text-[#666666]">    
